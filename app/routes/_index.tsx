...
export default function Index() {
  return (
    <div className="p-xs flex flex-col h-screen">
      <div>
      ...
      <div className="p-2xs flex justify-center">
        <div className="max-w-[70ch] text-center text-balance">
          {/* <h1>A space to explore my thoughts, map out my learnings, and get lost in new ideas</h1> */}
          <p>Welcome! My name is Zack Myers, and this is a space to explore my thoughts, map out my learnings, and get lost in new ideas.</p>
        </div>
      </div>
      ...
      <div className="h-3xl bg-subtle"></div>
    </div >
  );
}
